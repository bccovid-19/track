...
CONTACT_EMAIL_FIELD_ID = 'customField18'
...
FACILITY_ADDRESS_EXPORTABLE_FIELD_ID = 'customField19'
FACILITY_REGION_FIELD_ID_NUM = 20
FACILITY_REGION_FIELD_ID = field_key(FACILITY_REGION_FIELD_ID_NUM)
REGION_FIELD_ID = 'customField16'
SUBJECT_FIELD_ID = 'subject'
NOTES_FIELD_ID = 'customField17'
